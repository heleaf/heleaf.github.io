...
- 15-458 Discrete Differential Geometry
  ...
  - Assignments are half written proofs/computations (usually not very rigorous but there are a lot of them), and half 112-122 level progs, due every 2 weeks. Grading is pretty lenient.
...
**Other**: [Penrose][penrose] team meetings (dropped), internship applications
...
**Other**: worked on [LIMINAL][liminal] with Game Creation Society, internship/research applications
