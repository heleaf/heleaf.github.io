...
- ☆ 60-220 IDeATe: Technical Character Animation
  ...
  - I think people typically take this class after having taken 60-125 (which I had not), but I think it turned out okay.
...
**Notes**: 
- Taking two 200-level CS cores together is typically disallowed by SCS advisors-- I got permission after having done well with a similar workload in S21, with the caveat that I would only take 4 courses.
- Having felt fine about 122 and 150 content, 213 + 210 together was still really hard for me (probably exasterbated by remote to in person transitions, 20 hrs/week of TAing, getting sick). I was pretty much always stressed and working on either one during the semester, with little to no free time. It's doable with good time management (starting early on both, staggering the labs on different weeks, not staying stuck for too long and going to OH), although that doesn't mean it's a good idea. 
